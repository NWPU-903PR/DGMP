...
#标签处理
ncg_known_cancer_genes = pd.read_table("C:/Users/xjy/Desktop/GCN_data/GCN_data/NCG6_tsgoncogene.tsv")
ncg_known_cancer_genes = list(ncg_known_cancer_genes['symbol'])

cgc_known_cancer_genes = pd.read_csv(r'C:\Users\xjy\Desktop\GCN_data\GCN_data\cancer_gene_census.csv',header=0)
cgc_known_cancer_genes = list(cgc_known_cancer_genes['Gene Symbol'])

into_known_cancer_genes = pd.read_table(r'C:\Users\xjy\Desktop\GCN_data\GCN_data\IntOGen-DriverGenes.tsv')
